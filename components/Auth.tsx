...
import { Loader2, ArrowRight, Mail, Lock, AlertCircle, Zap, Globe, Shield, ChevronLeft } from 'lucide-react';
      ...
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto w-full z-20">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => setMode('landing')}>
          <img 
            src="/icon.png" 
            alt="Logo" 
            className="w-10 h-10 rounded-xl shadow-lg shadow-purple-500/20 hover:scale-105 transition-transform"
          />
